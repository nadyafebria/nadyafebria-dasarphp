    ...
    <?php 
        ...
        if(isset($_GET['halaman'])){
            switch ($_GET['halaman']){
                ...
                case "hari3":
                    include "hariketiga/percobaan.php";
                    break;

                case "hari4":
                    include "hariempat/coba.php";
                    break;

                case "hari5":
                    include "harilima/tugas.php";
                    break;

                case "hari6":
                    include "harienam/tugas.php";
                    break;

                case "hari7":
                    include "haritujuh/prima.php";
                    break;

                case "hari8":
                    include "haridelapan/method.php";
                    break;
                default:
                    include "welcome.php";
            }
